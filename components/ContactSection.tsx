        ...
        <div>
          ...
          <form className="mt-8 grid gap-4">
            <div className="grid gap-4 md:grid-cols-2">
              <input
                className="rounded-2xl border border-white/10 bg-white/[0.045] px-5 py-4 text-sm outline-none transition placeholder:text-white/35 focus:border-neon/60"
            ...
            <textarea
              className="min-h-[150px] resize-none rounded-2xl border border-white/10 bg-white/[0.045] px-5 py-4 text-sm outline-none transition placeholder:text-white/35 focus:border-neon/60"
