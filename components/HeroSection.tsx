...
export function HeroSection() {
  return (
    <section className="glass-panel min-h-[650px] p-6 md:p-10 lg:p-12">
      ...
      <div className="grid min-h-[540px] items-center gap-10 lg:grid-cols-[42%_58%]">
        <div className="relative z-10 flex h-full flex-col justify-center">
          ...
          <motion.h1
            ...
            className="max-w-[560px] text-[48px] font-semibold leading-[0.98] tracking-[-0.055em] text-white md:text-[72px]"
          >
            Bringing Ideas
            <br />
        ...
        <motion.div
          ...
          className="relative h-[540px] overflow-hidden rounded-[30px] border border-white/10 bg-black"
        >
          <Image
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/72 via-black/20 to-black/10" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-black/10" />

          <OrbitRing className="bottom-24 left-[18%] h-56 w-[430px] rotate-[-18deg]" />

          <FloatingOrb className="left-14 top-16" size={64} delay={0.2} />
          <FloatingOrb className="bottom-20 right-24" size={38} delay={1.3} dark />
          <FloatingOrb className="right-20 top-20" size={84} delay={0.8} />
