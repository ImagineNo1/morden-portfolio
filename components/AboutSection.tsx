...
export function AboutSection() {
  return (
    <section id="about" className="glass-panel p-6 md:p-10 lg:p-12">
      <Reveal className="grid gap-10 lg:grid-cols-[45%_55%]">
        ...
        <div className="relative h-[520px] overflow-hidden rounded-[30px] border border-white/10 bg-black">
          <Image src="/images/hero-portrait.jpg" alt="About portrait" fill className="object-cover object-center" />
      ...
      <Reveal className="mt-10">
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          {tools.map((tool) => (
            <span key={tool} className="rounded-full border border-neon/35 bg-neon/10 px-5 py-3 text-sm font-semibold text-white">
              {tool}
            </span>
          ))}
        </div>
